...
<div id="titlewrap">
	...
	<input type="text" name="post_title" size="30" tabindex="1" <?php if ( defined("FL_MAX_CHARS_IN_TITLE") ) { echo 'maxlength="' . FL_MAX_CHARS_IN_TITLE . '" '; } ?>value="<?php echo esc_attr( htmlspecialchars( $post->post_title ) ); ?>" id="title" autocomplete="off" />
</div>
<div class="inside">
<?php
