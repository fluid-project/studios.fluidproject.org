...
<div id="titlewrap">
	...
	<input type="text" name="post_title" size="30" tabindex="1" <?php if ( defined("MAX_CHARS_IN_POST_TITLE") ) { echo 'maxlength="' . MAX_CHARS_IN_POST_TITLE . '" '; } ?>value="<?php echo esc_attr( htmlspecialchars( $post->post_title ) ); ?>" id="title" autocomplete="off" />
</div>
<div class="inside">
<?php
